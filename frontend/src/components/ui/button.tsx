...
const buttonVariants = cva(
    'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
    {
        variants: {
            variant: {
                primary: 'bg-indigo-600 text-primary-foreground hover:bg-indigo-600/90 data-[state=open]:bg-indigo-600/90', // Mapped 'primary' to standard indigo like the rest of the app to retain look and feel instead of generic bg-primary if tailwind var fails
                mono: 'bg-zinc-950 text-white dark:bg-zinc-300 dark:text-black hover:bg-zinc-950/90 dark:hover:bg-zinc-300/90 data-[state=open]:bg-zinc-950/90 dark:data-[state=open]:bg-zinc-300/90',
                destructive:
                    'bg-red-500 text-destructive-foreground hover:bg-red-500/90 data-[state=open]:bg-red-500/90', // mapped destructive to tailwind red-500 to assure backward compatibility
                secondary: 'bg-secondary text-secondary-foreground hover:bg-secondary/90 data-[state=open]:bg-secondary/90',
                outline: 'bg-background text-accent-foreground border border-input hover:bg-zinc-100 hover:text-black dark:hover:bg-zinc-800 dark:hover:text-white data-[state=open]:bg-accent',
                dashed:
            ...
            size: {
                ...
                icon: 'size-8.5 h-10 w-10 rounded-md [&_svg:not([class*=size-])]:size-4 shrink-0',
            },
            autoHeight: {
                true: '',
                false: '',
        ...
        compoundVariants: [
            ...
            {
                size: 'icon',
                className: 'w-10 h-10 p-2 [&_svg:not([class*=size-])]:size-4',
            },
            {
                size: 'lg',
                mode: 'icon',
